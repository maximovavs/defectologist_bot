...
# =========================
# LLM rewrite
# (moved to src/services/llm_generator.py)
# =========================

from src.services.llm_generator import (
    REQUIRED_HEADINGS_V3 as _REQUIRED_HEADINGS_V3,
    NAV_KEYS as _NAV_KEYS,
...
def compose_post_plain_v31(
    ...
    final_plain, used_rewrite, note = rewrite_if_enabled_plain(
        raw_plain,
        aud,
        rf,
        REWRITE_PROVIDER,
...
# =========================
# Card rendering
# (moved to src/services/image_builder.py)
# =========================
