    ...
    for aud in aud_list:
        ...
        for rubric in rubrics:
            ...
            if (rubric.get("format") or "").strip().lower() == "quality_dashboard":
                # HOTFIX: dashboard is TECHNICAL ONLY -> ALWAYS post to TELEGRAM_DRAFTS_CHAT_ID
                ...
                if TELEGRAM_CHAT_ID and TELEGRAM_CHAT_ID == TELEGRAM_DRAFTS_CHAT_ID:
                    print("[WARN] TELEGRAM_CHAT_ID == TELEGRAM_DRAFTS_CHAT_ID. Проверь секреты: тех-чат и публичный чат совпали.")
