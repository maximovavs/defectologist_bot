...
"""
Publisher (cron/GitHub Actions) v4.2.1
...
9) Исправлен slugify для возраста:
   - корректно обрабатывает дефисы -, –, —, −
   - устранён re.error: bad character range
"""
...
USER_AGENT = "logoped-channel-bot/4.2.1 (+https://github.com/)"
